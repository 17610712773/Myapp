package wandroid.group4.com.myapplication.modlue.http;
...
import wandroid.group4.com.myapplication.constances.Constant;
import wandroid.group4.com.myapplication.modlue.api.Shouyeapi;
...
public class HttpManager {
    ...
    private static Shouyeapi sShouyeapi;
    ...
    * 首页
    * */
    public static Shouyeapi getApizhishi() {
        synchronized (HttpManager.class) {
            if (sShouyeapi == null) {
                synchronized (HttpManager.class) {
                    sShouyeapi = getServerApis(Constant.BASE_URL, Shouyeapi.class);
                }
            }
        }
        return sShouyeapi;
